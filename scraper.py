                ...
                if dress[0] == bm_drs[0]:
                    ...
                    for size in dress[1]:
                        if size not in bm_drs[1]:
                            ...
                            time.sleep(2)
                            size_select = driver.find_element_by_name(
                                'attribute_pa_size[' + str(len(len_sizes) - 2) + ']')
...
if __name__ == '__main__':
    ...
    for site in dress_pages:
        compare_dress(site, bigmoda_pages[0], bigmoda_pages[2], driver)
        for dress in site:
            goods_data.append(dress)
    # for site in blouse_pages:
    #     compare_dress(site, bigmoda_pages[1], bigmoda_pages[2], driver)
    #     for blouse in site:
